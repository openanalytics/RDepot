    ...
    <div class="feed">
        <div class="PackageDetail">
            ...
            <div class="breadcrumb">
                <a href="<c:url value='/manager/repositories' />"><spring:message code="repository.title"/></a> 
                &gt; ${repository.name}
           </div>
           <p class="description">
           ...
           <table class="author_info">
               ...
               <tr>
                   <td><spring:message code="table.header.publicationuri"/></td>
                   <td><a href="<c:url value='/manager/repositories' />/${repository.id}/published">${repository.publicationUri}</a></td>
               </tr>
               <tr>
                   <td><spring:message code="table.header.serveraddress"/></td>
                   <td>${repository.serverAddress}</td>
               </tr>
               <tr>
                   <td><spring:message code="table.header.version"/></td>
                   <td>${repository.version}</td>
               </tr>
               <tr>
                   <td><spring:message code="table.header.published"/></td>
                   <td>
                        <c:choose>
