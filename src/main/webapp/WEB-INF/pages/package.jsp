...
<div id="bodyColumn">
    ...
    <div class="feed">
        <div class="PackageDetail">
            <h2>${packageBag.name}</h2>
            <div class="breadcrumb">
                <a href="<c:url value='/manager/packages' />"><spring:message code="package.title"/></a> 
                &gt; ${packageBag.name}
           </div>
           <p class="description">
           ...
           <table class="author_info">
               ...
               <tr>
                   <td><spring:message code="table.header.description"/></td>
                   <td>${packageBag.description}</td>
               </tr>
               <tr>
                   <td><spring:message code="table.header.maintainer"/></td>
                   <td><a href="<c:url value='/manager/users' />/${packageBag.user.login}">${packageBag.user.name}</a></td>
               </tr>
                              <tr>
