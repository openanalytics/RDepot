...
0	7	http://localhost/repo/D	D	http://oa-rdepot-repo:8080/D	f	f
\.
...
4	4	Albert Einstein	einstein@ldap.forumsys.com	einstein	t	2021-03-25	f
\.
...
10	2021-03-25	4	3	last logged in	2020-08-28 00:00:00.0	Thu Mar 25 09:32:21 GMT 2021	8	09:32:21.41+00
\.
...
SELECT pg_catalog.setval('public."RepositoryEvent_id_seq"', 14, true);
...
SELECT pg_catalog.setval('public."UserEvent_id_seq"', 10, true);
