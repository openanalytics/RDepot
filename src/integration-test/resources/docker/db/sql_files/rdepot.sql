...
364	07:18:28.512+00	2022-09-09	CREATE	4	5	\N	\N	\N	\N	\N	f
\.
...
SELECT pg_catalog.setval('public.package_maintainer_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.newsfeed_event_id_seq', 365, false);
