...
public class ArchiveIndexTest {
    ...
    public void testSerialize() throws IOException {
        ...
        fooArchives.add(
                new ArchiveInfo("foo/foo.tar.gz", 24803, 436, time, time, time, 1000, 1000, "einstein", "scientists"));

        archives.put("foo", fooArchives);

        ArrayList<ArchiveInfo> barArchives = new ArrayList<>();
        barArchives.add(new ArchiveInfo(
                "bar/bar_1.0.0.tar.gz", 24803, 436, time, time, time, 1000, 1000, "einstein", "scientists"));
        barArchives.add(new ArchiveInfo(
                "bar/bar_2.0.0.tar.gz", 24803, 436, time, time, time, 1000, 1000, "einstein", "scientists"));
