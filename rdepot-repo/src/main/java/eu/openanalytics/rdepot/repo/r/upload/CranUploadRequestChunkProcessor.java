...
@Component
public class CranUploadRequestChunkProcessor
        extends UploadRequestChunkProcessorImpl<SynchronizeCranRepositoryRequestBody> {
    public CranUploadRequestChunkProcessor(CranFileSystemStorageService storageService) {
