...
public class PythonPackageUploadStrategy extends DefaultPackageUploadStrategy<PythonRepository, PythonPackage> {
	...
	public PythonPackageUploadStrategy(
		...
		super(request, 
				...
				securityMediator, packageDeleter);
	}
	
	@Override
	protected PythonPackage parseTechnologySpecificPackageProperties(Properties properties) throws ParsePackagePropertiesException {
