...
public class PythonFSLocalStorage extends CommonFSLocalStorage<PythonPackage> implements PythonLocalStorage {

    private final PythonProperties pythonProperties;

    @Override
    public void setCheckSum(PythonPackage packageBag, File sourceFile) throws CheckSumCalculationException {
