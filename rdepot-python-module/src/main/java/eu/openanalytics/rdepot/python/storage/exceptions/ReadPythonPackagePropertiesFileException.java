...
public class ReadPythonPackagePropertiesFileException extends ReadPackageDescriptionException {
    @Serial
    private static final long serialVersionUID = 1L;

    public ReadPythonPackagePropertiesFileException() {
        super(PythonMessageCodes.READ_PYTHON_PROPERTIES_FILE_EXCEPTION);
    }
}
