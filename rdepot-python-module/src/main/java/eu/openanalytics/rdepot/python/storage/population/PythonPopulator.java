...
/**
 * Provides features specific for Python Packages localStorage management.
 */
public interface PythonPopulator extends Populator<PythonRepository, PythonPackage> {
    /**
     * Builds request body with objects ready to be uploaded to the remote server.
     * @param populatedRepositoryContent content to be uploaded
     ...
     * @param populatedRepositoryContent content to be cleaned
     */
    ...
    /**
     * Extracts the binary package
     */
    List<File> extractWhlPackageFile(String storedFilePath) throws ExtractFileException;
}
