...
@Configuration
@ComponentScan({
    "eu.openanalytics.rdepot.python.api.v2.controllers",
    "eu.openanalytics.rdepot.base.api.v2.controllers",
    "eu.openanalytics.rdepot.python.api.v2",
