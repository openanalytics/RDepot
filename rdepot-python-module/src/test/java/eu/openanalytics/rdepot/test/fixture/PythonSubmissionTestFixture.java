...
public class PythonSubmissionTestFixture {

	public static final String CHANGES = "Some changes 123";
	
	public static List<Submission> GET_FIXTURE_SUBMISSIONS(User user, PythonPackage packageBag, int count){
	...
	public static Submission GET_FIXTURE_SUBMISSION(User user, PythonPackage packageBag) {
