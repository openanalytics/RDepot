...
import eu.openanalytics.rdepot.security.RestAccessDeniedHandler;
import eu.openanalytics.rdepot.security.RestAuthenticationEntryPoint;

/**
 * Simple security configuration for API unit tests.
 */
@Configuration
@ComponentScan({"eu.openanalytics.rdepot.api.v2", "eu.openanalytics.rdepot.api.v2"})
@EnableWebSecurity
@EnableAutoConfiguration
@EnableGlobalMethodSecurity(prePostEnabled = true)
@EnableAsync
public class TestConfig extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
