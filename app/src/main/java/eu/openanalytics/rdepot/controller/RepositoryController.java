...
public class RepositoryController {
	...
	public @ResponseBody ResponseEntity<HashMap<String, Object>> createNewRepository(
		...
		if(Boolean.valueOf(declarative)) {
		...
		} else if(requester == null || !Objects.equals(requester.getRole().getName(), "admin")) { //TODO: Should we check if requester is not null?
			...
			if (bindingResult.hasErrors()) {
				...
				httpStatus = HttpStatus.UNPROCESSABLE_ENTITY; //TODO: Is it a correct message code?
			} else {	
				try {
