...
public class PackageException extends Exception {
	...
	private static final long serialVersionUID = 3682657463511599209L;
	
	public PackageException(String messageCode, MessageSource messageSource, Locale locale, Package packageBag) {
