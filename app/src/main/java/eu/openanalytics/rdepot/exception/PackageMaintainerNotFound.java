...
public class PackageMaintainerNotFound extends PackageMaintainerException {
	...
	public PackageMaintainerNotFound(int id, MessageSource messageSource, Locale locale) {
		super(MessageCodes.ERROR_PACKAGEMAINTAINER_NOT_FOUND, messageSource, locale, id);
	}
}
