...
public class RepositoryDeleteException extends RepositoryException {
	...
	public RepositoryDeleteException(MessageSource messageSource, Locale locale, Repository repository) {
		super(MessageCodes.ERROR_REPOSITORY_DELETE, messageSource, locale, repository);
	}
}
