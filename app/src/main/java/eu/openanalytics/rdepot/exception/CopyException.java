...
public class CopyException extends StorageException {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5276285675266655760L;

	public CopyException(MessageSource messageSource, Locale locale, 
