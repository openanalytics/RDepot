...
public class SubmissionController {	
	...
	public @ResponseBody ResponseEntity<?> createSubmission(
		...
		if(uploader == null) {
			...
			} catch(SubmissionCreateWarning | UploadRequestValidationWarning w) {
...
//					emailService.sendCanceledSubmissionEmail(submission);
	...
	@ResponseStatus(HttpStatus.OK)
	public @ResponseBody ResponseEntity<HashMap<String, String>> shiftDeleteSubmission(@PathVariable Integer id) throws SubmissionDeleteException, SubmissionNotFound, PackageDeleteException {
		Locale locale = LocaleContextHolder.getLocale();
		HttpStatus httpStatus = HttpStatus.OK;
