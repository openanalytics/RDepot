...
public class RDeclarativeIntegrationTest extends DeclarativeIntegrationTest {
	...
	public static final String REPOSITORYMAINTAINER_TOKEN = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9..6o7URshlNb91K9DKig79XIk9ozhomwaBmLg6im1JgbeWfJJUOP9k-gLTmWWHZkBC32MGKKFR-U11QzYY6G7zsw";
	public static final String PACKAGEMAINTAINER_TOKEN = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJnYWxpZWxlbyIsImVtYWlsIjoiZ2FsaWVsZW9AbGRhcC5mb3J1bXN5cy5jb20iLCJuYW1lIjoiR2FsaWxlbyBHYWxpbGVpIiwiYXVkIjoiUkRlcG90Iiwicm9sZXMiOlsidXNlciIsInBhY2thZ2VtYWludGFpbmVyIl0sImlzcyI6IlJEZXBvdCIsImV4cCI6MjAwNzAyNzQ5MSwiaWF0IjoxNjkxNjY3NDkxfQ.24gRyDswxCmos1mUTkRJEKkrt3L2MFfyHEXa_H5EBhi3yirIN8AT7Bn_NYaTEtGcEfVd8NUQtgzm9uck76N2SQ";
...
//		RestAssured.port = 8017;
	...
	public void shouldRetrievePublicConfig() throws Exception {
		...
		assertEquals("Incorrect public configuration returned.",
	...
	private Boolean assertSynchronizationFinished(String repositoryId) {		
		...
		if(actualJson.get("data").getAsJsonObject().get("repositoryId").getAsString().equals(repositoryId) && 
				actualJson.get("data").getAsJsonObject().get("pending").getAsString().equals("false"))
			return true;	
		return false;
	}
