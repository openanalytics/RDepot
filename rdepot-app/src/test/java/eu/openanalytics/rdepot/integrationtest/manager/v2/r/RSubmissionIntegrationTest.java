...
public class RSubmissionIntegrationTest extends IntegrationTest {		
	...
	public void submitPackage_createManualsByDefault() throws Exception {	
		...
		SubmissionMultipartBody body = new SubmissionMultipartBody("testrepo2", true, false, new MultiPartSpecBuilder(Files.readAllBytes(packageBag.toPath()))
...
//				.token(ADMIN_TOKEN)
//				.howManyNewEventsShouldBeCreated(testData.getPostEndpointNewEventsAmount())
//				.expectedEventsJson("/v2/events/submissions/r/new_submission_events.json")
//				.submissionMultipartBody(body)
//				.build();
//		testEndpoint(requestBody);	
//
...
//				.token(ADMIN_TOKEN)
//				.howManyNewEventsShouldBeCreated(testData.getPostEndpointNewEventsAmount())
//				.expectedEventsJson("/v2/events/submissions/r/replace_submission_events.json")
//				.submissionMultipartBody(body)
//				.build();
//		testEndpoint(requestBody);
//		
...
//				.expectedEventsJson("/v2/events/submissions/r/new_submission_without_manual_events.json")
//				.build();
//		testEndpoint(requestBody);
//	}
	...
	public void submitPackage_notReplace() throws Exception {
		File packageBag = new
				File ("src/test/resources/itestPackages/A3_0.9.1.tar.gz");
		SubmissionMultipartBody body = new SubmissionMultipartBody("testrepo2", false, true, new MultiPartSpecBuilder(Files.readAllBytes(packageBag.toPath()))
				.fileName(packageBag.getName())
				.mimeType("application/gzip")
				.controlName("file")
	...
	public void submitPythonPackage_shouldFail() throws Exception {
		File packageBag = new
				File ("src/test/resources/itestPackages/pandas_2.0.1.tar.gz");
		SubmissionMultipartBody body = new SubmissionMultipartBody("testrepo2", false, true, new MultiPartSpecBuilder(Files.readAllBytes(packageBag.toPath()))
				.fileName(packageBag.getName())
				.mimeType("application/gzip")
				.controlName("file")
