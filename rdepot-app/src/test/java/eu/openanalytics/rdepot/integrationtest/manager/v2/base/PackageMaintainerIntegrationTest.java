...
public class PackageMaintainerIntegrationTest extends IntegrationTest {
	...
	public void getPackageMaintainersByTechnologyWithSearching() throws Exception {
		TestRequestBody requestBody = TestRequestBody.builder()
				.requestType(RequestType.GET)
				.urlSuffix("?technology=" + testData.getTechnologies().get(1) + "&search=" + testData.getSearch() + "&sort=repository.id,asc")
				.statusCode(200)
				.token(REPOSITORYMAINTAINER_TOKEN)
				.howManyNewEventsShouldBeCreated(testData.getGetEndpointNewEventsAmount())
	...
	public void getMaintainer_returns403_whenUserIsNotAllowedToSee() throws Exception {
		testGetEndpoint("/v2/403.json", 
				"/" + testData.getPackageMaintainerOnlyForAdminId(), 403, REPOSITORYMAINTAINER_TOKEN, false);
	}

	@Test
	public void getMaintainer_whenUserIsAllowed() throws Exception {
		testGetEndpoint("/v2/base/package-maintainer/maintainer.json", 
				"/" + testData.getPackageMaintainerForRepositoryMaintainerId(), 200,
				REPOSITORYMAINTAINER_TOKEN, false);
	}
	...
	public void createMaintainer() throws Exception {
		...
		testGetEndpoint("/v2/base/package-maintainer/maintainers_after_creation.json", "?sort=id,asc", 200, ADMIN_TOKEN, false);
	}
  ...
  @Test
	public void createMaintainer_whenUserIsRepositoryMaintainerInTheSameRepository() throws Exception {
		...
		testPostEndpoint(body, "/v2/base/package-maintainer/maintainer_created_by_repository_maintainer.json", 201, REPOSITORYMAINTAINER_TOKEN);
		testGetEndpoint("/v2/base/package-maintainer/maintainers_after_creation_by_repository_maintainer.json", "?sort=id,asc", 200, ADMIN_TOKEN, false);
	}
	...
	public void patchMaintainer_delete() throws Exception {
		...
		testGetEndpoint("/v2/base/package-maintainer/deleted_maintainer_after_patch.json", "/1", 200, ADMIN_TOKEN, false);
	}
	...
	public void patchMaintainer_returns422_whenPatchIsMalformed() throws Exception {
		...
		testGetEndpoint("/v2/base/package-maintainer/maintainers_asadmin.json", "?sort=id,asc", 200, ADMIN_TOKEN, false);
	}
