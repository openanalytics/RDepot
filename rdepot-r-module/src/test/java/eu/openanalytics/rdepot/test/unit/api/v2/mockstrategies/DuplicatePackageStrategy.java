...
public class DuplicatePackageStrategy extends Strategy<Submission> {
     ...
     */
    public DuplicatePackageStrategy(Submission resource, Service<Submission> service, User requester, NewsfeedEventService newsfeedEventService) {
        super(resource, service, requester, newsfeedEventService);
    }

    @Override
    protected Submission actualStrategy() throws StrategyFailure {
        throw new StrategyFailure(new PackageDuplicateWithReplaceOff(resource),
                false);
    }
