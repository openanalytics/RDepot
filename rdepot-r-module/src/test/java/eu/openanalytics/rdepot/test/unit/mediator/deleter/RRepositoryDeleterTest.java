...
public class RRepositoryDeleterTest extends UnitTest {
	...
	public void setUpResources() {
		...
		repositoryMaintainers = RepositoryMaintainerTestFixture.GET_REPOSITORY_MAINTAINERS_FOR_REPOSITORY(2, repository);
		packages = RPackageTestFixture.GET_PACKAGES_FOR_REPOSITORY_AND_USER(3, repository, user);
	}
