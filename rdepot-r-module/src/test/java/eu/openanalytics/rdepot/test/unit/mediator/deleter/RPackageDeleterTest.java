...
public class RPackageDeleterTest extends UnitTest {
	...
	private final static String OLD_SOURCE = "/upload_folder/package.tar.gz";
	private final static String TRASHED_SOURCE = "/trash/package.tar.gz";
	...
	@Test
	public void delete_throwsExceptionAndResotresSources_whenDataAccessExceptionOccurs() 
			throws Exception {
		...
		assertEquals(OLD_SOURCE, packageBag.getSource(), 
				"Package source has not been moved back to its previous place.");
