...
public class RPackageControllerTest extends ApiV2ControllerUnitTest {
	...
	public void patchPackage_returns422_whenValidationFails() throws Exception {
		...
		}).when(rPackageValidator).validate(any(), eq(true), any());
		mockMvc.perform(MockMvcRequestBuilders.patch("/api/v2/manager/r/packages/" + packageBag.getId())
	...
	public void patchPackage_returns500_whenErrorIsThrown() throws Exception {
		...
		ResultActions result = mockMvc.perform(MockMvcRequestBuilders.patch("/api/v2/manager/r/packages/" + packageBag.getId())
				.content(patchJson).contentType("application/json-patch+json"))
