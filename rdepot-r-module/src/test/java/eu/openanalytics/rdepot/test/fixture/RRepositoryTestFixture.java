...
public class RRepositoryTestFixture {
	...
	public static List<RRepository> GET_EXAMPLE_REPOSITORIES() {
		...
		repository2.setName("Test Repository 456");
		...
		repository3.setName("Test Repository 321");
...
//				<Repository>(id, "http://localhost/repo/testrepo" + id, "Test Repository " + id, "http://192.168.1.100/testrepo" + id, false, false, null, null, null);
