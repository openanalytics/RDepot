...
public class RRepositorySynchronizerTest extends UnitTest {
    ...
    public void storeRepositoryOnRemoteServer_withSingleChunk() throws Exception {
        ...
        final PopulatedRepositoryContent populatedContent =
                new PopulatedRepositoryContent(onlyLatest, onlyArchive, latestPath, archivePath);
        final List<File> packagesToUpload = List.of(
                new File(TEST_PACKAGES_PATH + "/abc_1.3.tar.gz"), new File(TEST_PACKAGES_PATH + "/accrued_1.3.tar.gz"));
        final List<File> packagesToUploadToArchive = List.of(new File(TEST_PACKAGES_PATH + "/accrued_1.2.tar.gz"));
        ...
        checksums.put("PACKAGES", "639bf3e988764b375fa2fbdbf0ed0b74");
        checksums.put("PACKAGES_ARCHIVE", "65e7f749cf8315c5c8255da701c5a844");
        checksums.put("PACKAGES_ARCHIVE.gz", "df767a18774c0af24bb6b92f77b034e5");
        checksums.put("PACKAGES.gz", "6a075ae72dcc3cc37a75f1df68816a14");
        ...
        doReturn(populatedContent)
                .when(storage)
                .organizePackagesInStorage(DATESTAMP, packages, onlyLatest, onlyArchive, repository);

        doReturn(requestBody)
                .when(storage)
                .buildSynchronizeRequestBody(
                        populatedContent, new ArrayList<>(), new ArrayList<>(), repository, versionBefore);
    ...
    public void storeRepositoryOnRemoteServer_withMultipleChunks() throws Exception {
        ...
        final PopulatedRepositoryContent populatedContent =
                new PopulatedRepositoryContent(packagesLatest, packagesArchive, latestPath, archivePath);

        final List<File> packagesToUpload = packagesLatest.stream()
                .map(p -> new File(p.getSource()))
                .collect(Collectors.toCollection(ArrayList::new));
        final List<File> packagesToUploadToArchive = packagesArchive.stream()
                .map(p -> new File(p.getSource()))
                .collect(Collectors.toCollection(ArrayList::new));
        ...
        doReturn(populatedContent)
                .when(storage)
                .organizePackagesInStorage(DATESTAMP, packages, packagesLatest, packagesArchive, repository);
        doNothing().when(storage).cleanUpAfterSynchronization(populatedContent);
        ...
        final Map<String, String> checksums = new HashMap<>();
        checksums.put("PACKAGES", "91fc181b3c9c4b356d8c9c64daeb2aa3");
        checksums.put("PACKAGES_ARCHIVE", "57d68e9cb8c17a92a5c91de506471674");
        checksums.put("PACKAGES_ARCHIVE.gz", "20d5badb99fc5f7fd9842dcc215e2eca");
        checksums.put("PACKAGES.gz", "c960f8caabf8fc6d4e214f2d7fcea83b");
        checksums.put("testpackage1_1.0.0.tar.gz", "c47d18b86b331a5023dcd62b74fedbb6");
        checksums.put("testpackage1_1.0.1.tar.gz", "c47d18b86b331a5023dcd62b74fedbb6");
        checksums.put("testpackage1_3.0.0.tar.gz", "c47d18b86b331a5023dcd62b74fedbb6");
        checksums.put("testpackage2_1.0.0.tar.gz", "c47d18b86b331a5023dcd62b74fedbb6");
        checksums.put("testpackage2_1.1.0.tar.gz", "c47d18b86b331a5023dcd62b74fedbb6");
        checksums.put("testpackage2_2.1.0.tar.gz", "c47d18b86b331a5023dcd62b74fedbb6");
        checksums.put("testpackage2_3.2.1.tar.gz", "c47d18b86b331a5023dcd62b74fedbb6");
        checksums.put("testpackage3_1.0.0.tar.gz", "c47d18b86b331a5023dcd62b74fedbb6");
        checksums.put("testpackage3_1.1.1.tar.gz", "c47d18b86b331a5023dcd62b74fedbb6");
        checksums.put("testpackage3_2.2.2.tar.gz", "c47d18b86b331a5023dcd62b74fedbb6");
        ...
        List<List<File>> chunksToUploadArchive =
                List.of(expectedFirstChunkArchive, packagesToUploadToArchive.subList(4, 7));
