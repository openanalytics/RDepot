...
public class RRepositoryDataInitializer
	...
	public RRepositoryDataInitializer(RRepositoryService repositoryService,
		...
		super(repositoryService, repositoryValidator, repositoryDeleter, 
				taskScheduler, cranMirrorSynchronizer, 
				rYamlDeclarativeConfigurationSource, RLanguage.instance);
