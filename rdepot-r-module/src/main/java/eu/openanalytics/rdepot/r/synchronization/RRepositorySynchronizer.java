...
public class RRepositorySynchronizer implements RepositorySynchronizer<RRepository> {
	...
	public final static Comparator<RPackage> PACKAGE_COMPARATOR
			= Comparator.comparingInt(RPackage::getId);
		...
		try {
			...
			for(MultiValueMap<String, Object> chunk : chunks) {
				...
				if(!httpResponse.getStatusCode().is2xxSuccessful() || 
						!Objects.equals(Objects.requireNonNull(httpResponse.getBody()).getMessage(), "OK")) {
