...
public class UpdateRepositoryMaintainerStrategyTest extends StrategyTest {
    ...
    private void updateRepositoryMaintainerRepositoryId() throws Exception {
        ...
        when(packageService.findAllByRepository(updatedMaintainer.getRepository()))
                .thenReturn(packagesListAfterUpdate);
        when(packageService.findAllByRepository(resource.getRepository())).thenReturn(packagesListBeforeUpdate);

        strategy = new UpdateRepositoryMaintainerStrategy(
    ...
    @Test
    public void updateRepositoryMaintainer_shouldNotUndelete() throws Exception {
        prepareForUndelete();
    ...
    @Test
    public void updatePackageMaintainerWhenCannotChooseBestMaintainerAfterChangeRepository() throws Exception {
    ...
    public void updatePackageMaintainerWhenCannotChooseBestMaintainerAfterSoftDelete() throws Exception {
        doThrow(NoSuitableMaintainerFound.class)
                .when(bestMaintainerChooser)
