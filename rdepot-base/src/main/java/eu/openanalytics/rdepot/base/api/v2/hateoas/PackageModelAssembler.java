...
public class PackageModelAssembler extends AbstractRoleAwareModelAssembler<Package, PackageDto> {
    ...
    public EntityModel<PackageDto> toModel(Package entity, Class<? extends ApiV2Controller<?, ?>> clazz) {
        ...
        return EntityModel.of(dto, generateAvailableLinksForEntity(entity, clazz));
    }
    ...
    protected Class<?> getExtensionControllerClass(Package entity) {
        return packageControllerClassesByTechnology.getOrDefault(entity.getTechnology(), ApiV2PackageController.class);
    }
}
