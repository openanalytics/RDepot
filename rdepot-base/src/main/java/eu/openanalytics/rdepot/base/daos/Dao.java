...
/**
 * Data Access Object - allows other components to access data from the database.
 * It is based on {@link JpaRepository JPA Repository}.
 * @param <T> Entity type that represents data.
 */
@NoRepositoryBean
