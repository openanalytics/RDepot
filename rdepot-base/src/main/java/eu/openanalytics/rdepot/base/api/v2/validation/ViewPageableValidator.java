...
@Component
@Slf4j
public class ViewPageableValidator {

    protected final MessageSource messageSource;
    protected static final Locale locale = LocaleContextHolder.getLocale();

    public void validate(Class<?> dtoClass, DtoResolvedPageable pageable) throws UnrecognizedQueryParameterException {
    ...
    private Set<String> getDtoFields(Class<?> dtoClass) {
