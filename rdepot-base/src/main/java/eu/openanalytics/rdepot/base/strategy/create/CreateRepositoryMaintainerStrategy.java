...
public class CreateRepositoryMaintainerStrategy extends CreateStrategy<RepositoryMaintainer> {
    ...
    public CreateRepositoryMaintainerStrategy(
    ...
    protected RepositoryMaintainer actualStrategy() throws StrategyFailure {
        ...
        Optional<RepositoryMaintainer> existingMaintainer =
                repositoryMaintainerService.findByRepositoryAndUserAndDeleted(
                        resource.getRepository(), resource.getUser(), true);
