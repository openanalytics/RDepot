...
public class AccessToken extends EventableResource {
	...
	public AccessToken(String name, String value, LocalDate creationDate, LocalDate expirationDate, boolean active, boolean deleted) {
		this();		
		this.name = name;
		this.value = value;
	...
	public AccessToken(int id, String name, String value, LocalDate creationDate, LocalDate expirationDate, boolean active, boolean deleted) {
		this();
		this.id = id;
		this.name = name;
		this.value = value;
	...
	public AccessToken(int id, String name, String value, LocalDate creationDate, LocalDate expirationDate, boolean active, boolean deleted, User user) {
		this();
		this.id = id;
		this.name = name;
		this.value = value;
