...
public interface Storage<R extends Repository, P extends Package> {
	 ...
	 * @return package file
	 */
	String writeToWaitingRoom(MultipartFile fileData, R repository) 
	 ...
	 */
	String moveToMainDirectory(P packageBag) 
	 ...
	 */
	Properties getPropertiesFromExtractedFile(String extractedFile) 
	 ...
	 */
	void populatePackage(P packageBag, String folderPath) 
