...
public class Oauth2SecurityConfig {
	...
	public Oauth2SecurityConfig(MessageSource messageSource,
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .oauth2ResourceServer(oauth2 -> {
                    ...
                    oauth2.authenticationEntryPoint(new RestAuthenticationEntryPoint(messageSource, locale, objectMapper));
                }
            );            
        return http.build();
    }
