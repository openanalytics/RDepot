...
@DiscriminatorColumn(name = "resource_technology", discriminatorType = DiscriminatorType.STRING, columnDefinition = "varchar default 'Package'")
public abstract class Package extends EventableResource 
	implements Comparable<Package>, Serializable {
	...
	protected Package(Technology technology, PackageDto packageDto, 
	...
	{	
		if (!this.getTechnology().equals(that.getTechnology())) {
			throw new IllegalArgumentException(
					"Trying to compare packages of different technologies "
