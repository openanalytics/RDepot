...
public class MessageCodes {
	...
	public static final String TOKEN_NUMBER_OF_DAYS_MUST_BE_GREATER_THAN_0 = "token.number.of.days.must.be.greater.than.0";
	public static final String TOKEN_NUMBER_OF_DAYS_MUST_BE_LESS_THAN_366 = "token.number.of.days.must.be.less.than.366";
