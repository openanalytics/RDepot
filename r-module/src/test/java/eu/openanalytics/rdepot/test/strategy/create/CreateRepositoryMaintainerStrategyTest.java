...
public class CreateRepositoryMaintainerStrategyTest extends StrategyTest {
	...
	private void createRepostioryMaintainer() throws Exception {
		...
		strategy = new CreateRepositoryMaintainerStrategy(resource, eventService, service, user, packageService,
	...
	@Test
	public void createRepositoryMaintainer_shouldFailWhenCannotChooseBestMaintainerAfterCreation() throws Exception {
