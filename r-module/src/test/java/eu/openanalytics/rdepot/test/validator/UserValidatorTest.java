...
public class UserValidatorTest {
	...
	public void validateUser_userNotFound() throws Exception {
		...
		verify(errors, times(1)).rejectValue("id", RefactoredMessageCodes.ERROR_USER_NOT_FOUND);		
	}
	...
	public void validateUser_allForbiddenUpdates() throws Exception {
		...
		verify(errors, times(1))
			.rejectValue("lastLoggedInOn", RefactoredMessageCodes.FORBIDDEN_UPDATE);
		verify(errors, times(1))
			.rejectValue("createdOn", RefactoredMessageCodes.FORBIDDEN_UPDATE);
		verify(errors, times(1))
			.rejectValue("name", RefactoredMessageCodes.FORBIDDEN_UPDATE);
		verify(errors, times(1))
			.rejectValue("login", RefactoredMessageCodes.FORBIDDEN_UPDATE);
		verify(errors, times(1))
			.rejectValue("email", RefactoredMessageCodes.FORBIDDEN_UPDATE);		
	}
	...
	public void validateUser_EmptyEmailLoginAndName() throws Exception {
		...
		userValidator.validate(updatedUser, errors);
		verify(errors, times(1))
			.rejectValue("email", RefactoredMessageCodes.ERROR_EMPTY_EMAIL);
		verify(errors, times(1))
			.rejectValue("login", RefactoredMessageCodes.ERROR_EMPTY_LOGIN);
		verify(errors, times(1))
			.rejectValue("name", RefactoredMessageCodes.ERROR_EMPTY_NAME);				
	}
	...
	public void validateUser_InvalidEmailAndDuplicateLogin() throws Exception {
		...
		userValidator.validate(updatedUser, errors);
		verify(errors, times(1))
			.rejectValue("email", RefactoredMessageCodes.ERROR_INVALID_EMAIL);
		verify(errors, times(1))
			.rejectValue("login", RefactoredMessageCodes.ERROR_DUPLICATE_LOGIN);					
	}
	...
	public void validateUser_DuplicateEmail() throws Exception {
		...
		User updatedUser = new User(user);
		updatedUser.setId(0);
		updatedUser.setEmail("testuser123@example.org");
		...
		userValidator.validate(updatedUser, errors);
		verify(errors, times(1))
			.rejectValue("email", RefactoredMessageCodes.ERROR_DUPLICATE_EMAIL);						
	}
}
