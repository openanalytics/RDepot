...
/**
 * Synchronizer published repository on a server 
 * so that it is accessible outside of the RDepot context.
 ...
 * @param <T>
 */
public interface RepositorySynchronizer<T extends Repository<T, ?>> {
	/**
